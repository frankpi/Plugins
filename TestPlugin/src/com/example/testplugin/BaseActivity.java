...
public class BaseActivity extends Activity {
    ...
    public static final String PROXY_VIEW_ACTION = "android.intent.action.View";
    public static final String DEX_PATH = Environment.getExternalStorageDirectory()+"/dl/TestPlugin.apk";
